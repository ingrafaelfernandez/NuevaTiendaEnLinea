...
// Tu API key de imgbb (necesitas una cuenta en https://api.imgbb.com/)
// Nota: En un proyecto real, esto debería estar en variables de entorno (.env)
const IMGBB_API_KEY = "72eebe1d96250005aa74a0faa592cfad"; // API key de imgbb configurada
...
// Función principal que usamos en ProductFormContainer
export const uploadImage = async (file) => {
  // Si no se proporciona archivo, devolver string vacío
  if (!file) return "";

  // Si ya es una URL, devolverla tal cual
  if (typeof file === "string") return file;

  // Si es un File, subir a imgbb
  try {
